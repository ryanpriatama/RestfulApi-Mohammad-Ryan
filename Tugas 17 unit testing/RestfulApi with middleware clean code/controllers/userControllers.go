...
//get 1 specified user info by id
...
//for testing
func CreateGetBookController(bookModel models.BookModel) echo.HandlerFunc {
...
func CreatePostBookController(bookModel models.BookModelPost) echo.HandlerFunc {
	return func(c echo.Context) error {
		books := bookModel.Post()
		return c.JSON(200, books)
	}
}

func CreateDeleteBookController(bookModel models.BookModelDelete) echo.HandlerFunc {
	return func(c echo.Context) error {
		books := bookModel.Delete()
		return c.JSON(200, books)
	}
}

func CreateUpdateBookController(bookModel models.BookModelUpdate) echo.HandlerFunc {
	return func(c echo.Context) error {
		books := bookModel.Update()
		return c.JSON(200, books)
	}
}
